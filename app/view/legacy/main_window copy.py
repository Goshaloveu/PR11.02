...
from app.view.legacy.gallery_interface import GalleryInterface
from app.view.home_interface import HomeInterface
from app.view.setting_interface import SettingInterface
from app.view.tables import ClientWidget, OwnerWidget
# from .text_interface import TextInterface
from app.view.view_interface import ViewInterface
from app.common.config import ZH_SUPPORT_URL, EN_SUPPORT_URL, cfg
...
class MainWindow(FluentWindow):
    ...
    def __init__(self, user):
        ...
        self.ClientInterface = ClientWidget(self.user, self)
        self.OwnerInterface = OwnerWidget(self.user, self)
    ...
    def initNavigation(self):
        ...
        # self.addSubInterface(self.flightInterface, FIF.AIRPLANE, "Рейсы", pos)
        # self.addSubInterface(self.ticketsInterface, FIF.TAG, "Билеты", pos)
        if self.user.type == "Соц. Работник":
            self.addSubInterface(self.OwnerInterface, FIF.PEOPLE, "Задания", pos)
        else:
            self.addSubInterface(self.ClientInterface, FIF.PEOPLE, "Задания", pos)
    ...
    def initWindow(self):
        ...
        self.setWindowIcon(QIcon(r'C:\Users\gosha\MDK_project\project\pic.png'))
    ...
    def onSupport(self):
        ...
        # сделать подсказку в виде всплывающего окна с информаией о команде разработчике
