...
"}")
        ...
        self.ComboBox.addItems(["Гражданин", "Соц. Работник"])
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_6.setText(_translate("Form", "Пароль"))
        self.lineEdit_4.setPlaceholderText(_translate("Form", "••••••••••••"))
        # self.checkBox.setText(_translate("Form", "Запомнить меня"))ss
...
class Ui_Form_Info(object):
    def setupUi(self, Form):
        ...
        self.widget.setSizePolicy(sizePolicy)
        self.widget.setMinimumSize(QtCore.QSize(360, 0))
        self.widget.setMaximumSize(QtCore.QSize(203234234, 16777215))
        self.widget.setStyleSheet("QLabel{\n"
"    font: 13px \'Microsoft YaHei\'\n"
"}")
        self.widget.setObjectName("widget")
        ...
        spacerItem = QtWidgets.QSpacerItem(20, 300, QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        ...
        self.verticalGender = QtWidgets.QVBoxLayout(self.widget)
        ...
        spacerItem2 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        ...
        self.category = ComboBox(self.widget)
        self.category.addItems(['Инвалид', 'Пожилой человек', 'Ребенок-инвалид', 'Многодетные', 'Беженец', 'Малоимущий'])
        self.category.setCurrentIndex(0)
        self.horizontalLayout_4.addWidget(self.category)
        self.verticalLayout.addLayout(self.horizontalLayout_4)
        spacerItem3 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Minimum)
...
import app.resource.resource_rc as resource_rcs
