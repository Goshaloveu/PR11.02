...
class BannerWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.galleryLabel = QLabel('Твори добро!', self)
        ...
        #     r'.\app\resource\images\Aeroflot_logo_(en)2.png',
        #     self.tr('Аэрофлот'),
        #     self.tr('Авиакомпания Аэрофлот распологается в Москве, Красноярске, Владивостоке и Калининграде. Флот состоит из Airbus 320 и Boing 737-800.'),
        #     "https://www.aeroflot.ru/ru-ru?utm_referrer=https%3A%2F%2Fwww.aeroflot.ru%2Fus-ru"
        # )

        # self.linkCardView.addCard(
        #     r".\app\resource\images\Aurora_airline_logo.svg",
        #     self.tr('Аврора'),
        #     self.tr(
        #         'Авиакомпания Аврора базируется во Владивостоке. Основной флот состоит из Airbus 319.'),
        #     "https://www.flyaurora.ru/?utm_source=google.com&utm_medium=organic&utm_campaign=google.com&utm_referrer=google.com"
        # )

        # self.linkCardView.addCard(
        #     r".\app\resource\images\Авиакомпания-Азимут.png",
        #     self.tr('Азимут'),
        #     self.tr(
        #         'Авиакомпания Азимут располагается в Ростове-на-Дону. Флот состоит из RRJ-95LR-100.'),
        #     "https://azimuth.ru/ru"
        # )

        # self.linkCardView.addCard(
        #     r".\app\resource\images\azur.png",
        #     self.tr('Азур-Эйр'),
        #     self.tr('Компания базируется во Внуково. Флот состоит из Boing 737-800, 757-200.'),
        #     "https://azur-airlines.com/"
        # )
